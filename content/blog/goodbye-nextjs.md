...
updated: 2025-08-16T02:59:03.000Z
excerpt: "A quick disclaimer. This article is not intended to disparage Next.js –\_I work with Next.js every day, and really quite enjoy it. This is simply a study in using an outsized solution for a trivial problem.\n\nIn 2023, I decided to re-create my personal website using Next.js. I even wrote about it. The building process was a lot of fun, and I even built a fun personal Twitter feed alternative.\n\nUnfortunately, when it came to updating the blog, things didn't quite go so well. It can be hard enough t"
feature_image: null
published: true
---
