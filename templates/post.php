...
<header class='page-header blah'>
  ...
  <?php if (isset($document->front_matter->date)) : ?><datetime class='text-slate-700 dark:text-slate-600 text-md'><?php echo date('F j, Y', strtotime($document->front_matter->date)); ?></datetime><?php endif; ?>
